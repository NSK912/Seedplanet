...
const CollisionCore = {
  ...
  checkCaveAndTerrainCollision: function(P_new, P_curr, centerRadius, charScale, swimFactor, wRadius, diveDepth, swimMoveFactor, charHeight) {
    ...
    const caveData = typeof getTerrainSurfaceAndCeiling === "function"
      ...
      : { ground: r_planet + (typeof getHeightOnSphere === "function" ? getHeightOnSphere(Math.acos(Math.max(-1, Math.min(1, P_new[1]))), Math.atan2(P_new[2], P_new[0]), typeof globalSeed !== 'undefined' ? globalSeed : 13585) : 0) * h_scale, ceiling: Infinity, insideTunnel: false };
    ...
    if (typeof getTerrainDensity === "function" && typeof tunnels3D !== "undefined" && tunnels3D.length > 0 && caveData.insideTunnel) {
        ...
        const getCaveDensity = (px, py, pz) => {
            ...
            const theta = Math.acos(Math.max(-1.0, Math.min(1.0, uy)));
            const phi = Math.atan2(uz, ux);
            const h = typeof getHeightOnSphere === "function" ? getHeightOnSphere(theta, phi, typeof globalSeed !== "undefined" ? globalSeed : 13585) : 0;
    ...
    const heightFinal = typeof getHeightOnSphere === "function" ? getHeightOnSphere(thetaFinal, phiFinal, typeof globalSeed !== 'undefined' ? globalSeed : 13585) : 0;
    ...
    const heightCurr = typeof getHeightOnSphere === "function" ? getHeightOnSphere(thetaCurr, phiCurr, typeof globalSeed !== 'undefined' ? globalSeed : 13585) : 0;
    ...
    function evaluatePosition(P, currentR) {
      ...
      const heightP = typeof getHeightOnSphere === "function" ? getHeightOnSphere(thetaP, phiP, typeof globalSeed !== 'undefined' ? globalSeed : 13585) : 0;
