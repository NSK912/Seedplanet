// === SEEDPLANET MODULE: JS/SAVE.JS ===
      ...
      function applySettings(settings, applySystemSettings = true, rebuildPlanet = false) {
        ...
        // Always sync RADIUS to currentGridSize on load to prevent mismatch
        ...
        if (typeof settings.renderDistValue === "number") {
          renderDistValue = settings.renderDistValue;
          const input = document.getElementById("renderDist");
          const label = document.getElementById("renderDistLabel");
